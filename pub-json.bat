...
REM Controleer of script bestaat
if not exist "scripts\generate_agents_publicatie.py" (
    echo [ERROR] Script niet gevonden: scripts\generate_agents_publicatie.py
    pause
    exit /b 1
)
...
REM Voer generate_agents_publicatie.py uit
echo [INFO] Start JSON publicatie...
echo.

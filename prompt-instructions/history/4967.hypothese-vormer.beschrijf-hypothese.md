...
## Parameters
  ...
  - `probleem`: voldoen aan eu-wetgeving
  - `idee_voor_de_oplossing`: klantportaal met dowloaden facturen
  - `auteur`: dalm
  - `bronnen`: https://www.dutchitchannel.nl/news/727447/ey-adviseert-verplichte-e-facturatie-voor-alle-b2b-transacties
  - `context`: afvalverwerking, leveren containers
  - `betrokkenen`: particulieren, grote klanten (aannemers bouw)
  - `agent`: hypothese-vormer

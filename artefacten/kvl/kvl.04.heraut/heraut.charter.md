...
<!-- Inhoud grotendeels overgenomen uit artefacten/kennisvastlegging/charters-agents/heraut.charter.md, maar met geactualiseerde value stream-naamgeving. Voor volledige tekst, zie origineel; verdere inhoud kan later één-op-één gemigreerd worden. -->

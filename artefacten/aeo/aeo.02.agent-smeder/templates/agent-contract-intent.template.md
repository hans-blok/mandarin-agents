...
**Formaat-normering**: 
{Voor agents met werking "Inhoudelijk":}
...
**Classificatie**: 
- Betekeniseffect: {beschrijvend/realiserend/evaluerend/normerend/geen}
- Interventieniveau: {werk/ontwerp/architectuur/ecosysteem}
- Werking: {inhoudelijk/representatie-omvormend/conditioneel}
- Bron-houding: {input-gebonden/canon-gebonden/externe-bron-gebonden/vrij}
...
8. ⚠️ **Formaat-normering**: alleen voor agents met werking "Inhoudelijk"
...
**Principe 9 — Output-formaat Normering (alleen agents met werking "Inhoudelijk"):**

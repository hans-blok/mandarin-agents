...
{Alle output wordt standaard in Markdown (.md) gegenereerd conform Principe 9 (Output-formaat Normering), tenzij expliciet anders gevraagd. Voor agents met werking "Inhoudelijk" is dit verplicht.}
...
6. ✅ Classificatie-combinatie gevalideerd met matrices

**Optioneel/aanpasbaar:**
7. ⚠️ **Werkwijze per intent-type**: alleen bij grote verschillen tussen intents
8. ⚠️ **Publicatiekopie**: alleen indien agent publiek wordt gepubliceerd
9. ⚠️ **Bootstrap header**: NIET in template zelf, wordt door run_prompt.py toegevoegd
...
- [ ] Voor agents met werking "Inhoudelijk": Markdown verplicht
...
4. [ ] Classificatie-combinatie geverifieerd in `mandarin-classificatie-matrices.md`
5. [ ] Minimaal 3 kerntaken gedefineerd
6. [ ] Grenzen-sectie bevat minimaal 5 WEL + 5 NIET items
7. [ ] Traceerbaarheid verwijst naar alle intents uit boundary
8. [ ] Output-locaties specificeren concrete paden
9. [ ] Bestandsnaam volgt conventie: `{agent}.charter.md`
10. [ ] Change log entry voor versie 1.0.0 aanwezig
11. [ ] Canon consultatie workflow expliciet opgenomen
...
5. **mandarin-ordeningsconcepten.md**:
   - Definitie van de 4 orthogonale assen
   - Semantische afbakening van as-posities

6. **mandarin-classificatie-matrices.md**:
   - Toegestane/verboden combinaties tussen as-posities
   - Consistentiecontrole van gekozen classificatie
...
- `mandarin-ordeningsconcepten.md` v1.10.0
- `mandarin-classificatie-matrices.md`
...
**Changelog:**
- v1.1.0 (2026-02-21): Classificatie geüniformeerd naar 4 orthogonale assen met verplichte matrix-validatie

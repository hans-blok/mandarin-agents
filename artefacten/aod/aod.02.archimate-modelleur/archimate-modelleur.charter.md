...
- Intent: `modelleer-motivatielaag`
  - Agent-contract: `artefacten/aod.02.archimate-modelleur/archimate-modelleur.modelleer-motivatielaag.agent.md`
  - Prompt-metadata: `artefacten/aod.02.archimate-modelleur/mandarin.archimate-modelleur-modelleer.motivatielaag.prompt.md`
- Intent: `modelleer-bedrijfslaag`
  - Agent-contract: `artefacten/aod.02.archimate-modelleur/archimate-modelleur.modelleer-bedrijfslaag.agent.md`
  - Prompt-metadata: `artefacten/aod.02.archimate-modelleur/mandarin.archimate-modelleur-modelleer.bedrijfslaag.prompt.md`
...
|-----------|--------|-------------------------------------------------------------------------------------------|---------------|
| 2026-02-04 | 1.1.0 | Charter herschreven volgens `agent-charter.template.md`, boundary geïntegreerd en verplaatst naar aod.02.archimate-modelleur | Agent Smeder  |

...
- Actor:
  - Naam/ID: data-duidingsarchitect
  - Versie: 1.0.0
...
Wanneer de **data-duidingsarchitect** handmatig wordt geïnitieerd (dus niet via een geautomatiseerde pipeline of runner), wordt een logbestand weggeschreven naar:

- **Locatie**: `logs/`
- **Bestandsnaam**: `yyyyddmm.HHmm data-duidingsarchitect.log`  

...
**VERPLICHT**: Lees artefacten/fnd.01.agent-curator/agent-curator-analyseer.charter.md voor volledige context, grenzen en werkwijze.
...
Voor alle details over werkwijze en kwaliteitsborging zie de charter in `artefacten/fnd.01.agent-curator/agent-curator-analyseer.charter.md`.

---

Documentatie: Zie artefacten/fnd.01.agent-curator/agent-curator-analyseer.charter.md  

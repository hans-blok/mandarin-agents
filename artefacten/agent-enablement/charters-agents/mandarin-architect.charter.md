...
- Contracten/prompts: exports/agent-enablement/agents/mandarin-architect.*.agent.md, exports/agent-enablement/prompts/mandarin.mandarin-architect.*.prompt.md

## 8. Output-locaties

- exports/agent-enablement/agents/ (agent-contracten)
- exports/agent-enablement/prompts/ (prompts)
- exports/agent-enablement/charters-agents/ (charter)

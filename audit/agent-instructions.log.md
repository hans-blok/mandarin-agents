...
## Agent Instructions — 2026-02-15T20:21:39.903520+01:00

- **Agent**: mandarin.core-framework-architect
- **Intent**: structureer-gedrag
- **Value Stream Fase**: aod.02
- **Prompt File**: `artefacten\aod\aod.02.core-framework-architect\prompts\mandarin.core-framework-architect.structureer-gedrag.prompt.md`
- **Parameters**:
...
## Agent Instructions — 2026-02-15T20:26:20.906342+01:00
...
- **Prompt File**: `artefacten\aod\aod.02.core-framework-architect\prompts\mandarin.core-framework-architect.structureer-gedrag.prompt.md`
- **Parameters**:
  - `landschap_naam`: Test Landschap
  - `domein`: test
  - `lagen`: Business,Application
  - `value_stream_fase`: aod.02
  - `agent`: core-framework-architect
  - `agent_naam`: core-framework-architect
  - `vs`: aod

---
execution_id: b8e4
execution_digest: 5ace07e07155
timestamp: 2026-04-06 19:52:51
...
## Parameters
  ...
  - `agent_naam`: positionering-en-monetisatie-toetser
  - `agent`: capability-architect
  - `value_stream_fase`: miv.07
  - `korte_beschrijving`: Toetst of een leverancier past bij de gekozen marktpositionering en monetisatie-logica van Mandarin en TLX.  **Waarom deze agent nodig is**  Hostingkeuze is hier niet alleen technisch. De leverancier moet ook passen bij een strategie waarin governance, traceerbaarheid, uitlegbaarheid, premium positionering en lage afhankelijkheid van gesloten platformlogica belangrijk zijn.  **Werkt op basis van**  - selectiecriteria uit de behoefteprofiel-opsteller - strategische intenties - spanningsvelden rond vendor lock-in versus interoperability - investerings- en positioneringsartefacten  **Belangrijkste taak**  - beoordeelt of de provider de governance-native propositie ondersteunt of juist ondermijnt - kijkt of de provider aansluit op een premium, betrouwbare en uitlegbare dienstverlening - signaleert of de leverancier toekomstige productisering of licentieerbaarheid belemmert

---
execution_id: e4c3
execution_digest: 905351339966
timestamp: 2026-04-06 19:36:42
...
Voer de intent `definieer-agent-charter` uit voor de agent `agent-ontwerper` op basis van onderstaande input en kaders uit grondslagen, beleid, charter en contract.
...
- **Toegepast profiel**: `agent-ontwerper.definieer-agent-charter`
...
| `doctrine-traceability.md` | kaderbron | doctrine | `5ac3` | vers | opgenomen | volledig | bronselectieprofiel 'agent-ontwerper.definieer-agent-charter' |
| `doctrine-agent-charter-normering.md` | kaderbron | doctrine | `3454` | vers | opgenomen | volledig | bronselectieprofiel 'agent-ontwerper.definieer-agent-charter' |
| `doctrine-bronhouding-en-exploratie.md` | kaderbron | doctrine | `2cf4` | vers | uitgesloten: profiel `agent-ontwerper.definieer-agent-charter` | — | uitgesloten: profiel 'agent-ontwerper.definieer-agent-charter' |
| `doctrine-handoff.md` | kaderbron | doctrine | `tbd0` | vers | uitgesloten: profiel `agent-ontwerper.definieer-agent-charter` | — | uitgesloten: profiel 'agent-ontwerper.definieer-agent-charter' |
| `doctrine-intent-naming.md` | kaderbron | doctrine | `045a` | vers | uitgesloten: profiel `agent-ontwerper.definieer-agent-charter` | — | uitgesloten: profiel 'agent-ontwerper.definieer-agent-charter' |
| `doctrine-agent-runner-architectuur.md` | kaderbron | doctrine | `c4fe` | vers | uitgesloten: profiel `agent-ontwerper.definieer-agent-charter` | — | uitgesloten: profiel 'agent-ontwerper.definieer-agent-charter' |
| `agent-ontwerper.charter.md` | kaderbron | charter | `—` | geladen | opgenomen | volledig | agent-charter voor agent-ontwerper |
| `agent-ontwerper.definieer-agent-charter.agent.md` | kaderbron | contract | `—` | geladen | opgenomen | volledig | agent-contract voor agent-ontwerper.definieer-agent-charter |

---
execution_id: 9140
execution_digest: 07c982006ef2
timestamp: 2026-04-13 20:37:54
...
Voer de intent `definieer-agent-template` uit voor de agent `agent-ontwerper` op basis van onderstaande input en kaders uit grondslagen, beleid, charter en contract.
...
## Parameters
  ...
  - `boundary_file`: artefacten/sfw/sfw.02.logisch-modelleur/logisch-modelleur.agent-boundary.md
...
- **Toegepast profiel**: `agent-ontwerper.definieer-agent-template`
...
| `doctrine-traceability.md` | kaderbron | doctrine | `5ac3` | vers | opgenomen | volledig | bronselectieprofiel 'agent-ontwerper.definieer-agent-template' |
| `doctrine-bronhouding-en-exploratie.md` | kaderbron | doctrine | `2cf4` | vers | uitgesloten: profiel `agent-ontwerper.definieer-agent-template` | — | uitgesloten: profiel 'agent-ontwerper.definieer-agent-template' |
| `doctrine-handoff.md` | kaderbron | doctrine | `tbd0` | vers | uitgesloten: profiel `agent-ontwerper.definieer-agent-template` | — | uitgesloten: profiel 'agent-ontwerper.definieer-agent-template' |
| `doctrine-templategebruik.md` | kaderbron | doctrine | `tbd0` | vers | uitgesloten: profiel `agent-ontwerper.definieer-agent-template` | — | uitgesloten: profiel 'agent-ontwerper.definieer-agent-template' |
| `agent-ontwerper.charter.md` | kaderbron | charter | `—` | geladen | opgenomen | volledig | agent-charter voor agent-ontwerper |
| `agent-ontwerper.definieer-agent-template.agent.md` | kaderbron | contract | `—` | geladen | opgenomen | volledig | agent-contract voor agent-ontwerper.definieer-agent-template |

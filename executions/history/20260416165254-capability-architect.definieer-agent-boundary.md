---
execution_id: 6b4d
execution_digest: 238e5c5fbc70
timestamp: 2026-04-16 16:52:55
...
## Parameters
  ...
  - `agent_naam`: knowledge-graph-modelleur
  - `agent`: capability-architect
  - `value_stream_fase`: aeo.01
  - `korte_beschrijving`: definieert graphs die toepasbaar zijn in Agentic AI. Heeft als bron vaak een logisch datamodel of een ander document dat een structuur heeft
...
| `doctrine-handoff.md` | kaderbron | doctrine | `c69b` | vers | uitgesloten: profiel `capability-architect.definieer-agent-boundary` | — | uitgesloten: profiel 'capability-architect.definieer-agent-boundary' |
| `doctrine-retrieval-en-contextselectie.md` | kaderbron | doctrine | `7c3b` | vers | uitgesloten: profiel `capability-architect.definieer-agent-boundary` | — | uitgesloten: profiel 'capability-architect.definieer-agent-boundary' |
...
| `doctrine.templategebruik.md` | kaderbron | doctrine | `1061` | vers | uitgesloten: profiel `capability-architect.definieer-agent-boundary` | — | uitgesloten: profiel 'capability-architect.definieer-agent-boundary' |
| `doctrine.traceability.md` | kaderbron | doctrine | `1a22` | vers | uitgesloten: profiel `capability-architect.definieer-agent-boundary` | — | uitgesloten: profiel 'capability-architect.definieer-agent-boundary' |

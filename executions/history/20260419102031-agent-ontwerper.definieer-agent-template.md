---
execution_id: 8c54
execution_digest: 5f04f2580384
timestamp: 2026-04-19 10:20:31
...
Voer de intent `definieer-agent-template` uit voor agent `agent-ontwerper`.
...
Overzicht van de bronnen die zijn samengesteld voor de uitvoering van intent `definieer-agent-template` door agent `agent-ontwerper`.
...
Na uitvoering van intent `definieer-agent-template`:

1. **Schrijf output weg** naar de afgesproken locatie conform het contract van `agent-ontwerper.definieer-agent-template`.

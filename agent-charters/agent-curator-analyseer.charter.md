...
- Geraadpleegde Grondslagen:
  ...
  - `grondslagen/aeo/*`
- Actor:
  - Naam/ID: agent-curator-analyseer
  - Versie: 1.0.0
...
- Intent: `ecosysteem`
  - Agent-contract: `artefacten/aeo.02.agent-curator/agent-curator.analyseer-ecosysteem.agent.md`
  - Prompt-metadata: `artefacten/aeo.02.agent-curator/mandarin.agent-curator-analyseer.ecosysteem.prompt.md`

De algemene governance- en boundary-afspraken voor de curator-functie zijn vastgelegd in:
- Charter Agent Curator (value stream agent-enablement, fase 02): `artefacten/aeo.02.agent-curator/agent-curator.charter.md`

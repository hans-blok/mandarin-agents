...
**VERPLICHT**: Lees artefacten/aeo.02.agent-curator/agent-curator-analyseer.charter.md voor volledige context, grenzen en werkwijze.
...
Voor alle details over werkwijze en kwaliteitsborging zie de charter in `artefacten/aeo.02.agent-curator/agent-curator-analyseer.charter.md`.

---

Documentatie: Zie artefacten/aeo.02.agent-curator/agent-curator-analyseer.charter.md  

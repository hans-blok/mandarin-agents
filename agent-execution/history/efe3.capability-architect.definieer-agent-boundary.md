...
## Parameters
  ...
  - `korte_beschrijving`: Beschrijft op een gestructureerde manier conform Safe epic-statements en doet voorstel voor verbeteringen.
  - `agent`: capability-architect
  - `vs`: sfw
  - `value_stream`: sfw
  - `fase`: 02

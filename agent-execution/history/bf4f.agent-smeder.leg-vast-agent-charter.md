...
# Agent Execution: agent-smeder — leg-vast-agent-charter
...
## Parameters
  ...
  - `value_stream_fase`: aeo.02
  - `fase`: 02
  - `boundary_file`: artefacten\aeo\aeo.02.task-drafter\task-drafter.agent-boundary.md
...
**Governance**: Volgt `beleid-workspace.md` (inclusief canon-raadpleging zoals daar vastgelegd) en `doctrine-agent-charter-
normering.md`; zie prompt files voor uitvoeringsdetails en grondslagen-patronen.

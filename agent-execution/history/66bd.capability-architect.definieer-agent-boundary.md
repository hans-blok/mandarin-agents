...
## Parameters
  ...
  - `korte_beschrijving`: Vertalen van een behoefte of wijzigingsvraag naar testbare gedragsrequirements in Gherkin (Given–When–Then), zó dat ze eenduidig, technologie-agnostisch en verifieerbaar zijn.
  - `agent`: capability-architect
  - `vs`: sfw
  - `value_stream`: sfw
  - `fase`: 03

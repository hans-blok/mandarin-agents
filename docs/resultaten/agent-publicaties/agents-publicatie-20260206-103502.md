...
|-------|--------|-----------|-----------|----------|
| canon-curator | Agent boundary-setting, value stream administratie, agent-ecosysteem oversight | 4 | 0 | 0 |
...
| agent-smeder | Agent-ontwerp, capability boundaries en contract-first uitvoering | 0 | 0 | 0 |
...
| Agent | Domein | Contracts | Templates | Runners |
|-------|--------|-----------|-----------|----------|
| strategisch-analist | Markt- en investeringsvorming, strategische intentie-explicitering | 0 | 0 | 0 |

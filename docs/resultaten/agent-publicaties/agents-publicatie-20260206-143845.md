...
| Agent | Domein | Contracts | Templates | Runners |
|-------|--------|-----------|-----------|----------|
| agent-curator | Agent-ecosysteem analyse en administratieve overzichten | 4 | 1 | 1 |
...
| Agent | Domein | Contracts | Templates | Runners |
|-------|--------|-----------|-----------|----------|
| mandarin-architect | architectuur | 2 | 1 | 0 |
...
| Agent | Domein | Contracts | Templates | Runners |
|-------|--------|-----------|-----------|----------|
| engineer-steward | Python-ontwikkeling, code-kwaliteit, technische stewardship | 3 | 1 | 0 |
| workspace-steward | Workspace-ordening, governance, agent-lifecycle | 5 | 1 | 0 |
...
| Agent | Domein | Contracts | Templates | Runners |
|-------|--------|-----------|-----------|----------|
| thema-verwoorder | themavorming naar epic-statement | 2 | 1 | 0 |

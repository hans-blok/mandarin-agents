...
| agent-smeder | Agent-ontwerp, capability boundaries en contract-first uitvoering | 3 | 1 |
...
| Agent | Domein | Prompts | Runners |
|-------|--------|---------|----------|
| pipeline-executor | Pipeline-uitvoering, workflow-orkestratie | 1 | 1 |
...
| artikel-schrijver | Artikelproductie, kennisoverdracht | 6 | 1 |
| de-schrijver | Narratieve tekstproductie, kennisoverdracht | 0 | 1 |
| essayist | Essayproductie, reflectieve kennisoverdracht | 1 | 1 |
| heraut | Canonieke aankondiging, governance communicatie | 2 | 0 |
| presentatie-architect | Presentatie-ontwerp | 1 | 0 |
| vertaler | Tekstvertaling, meertalige kennisoverdracht | 1 | 1 |
...
| Agent | Domein | Prompts | Runners |
|-------|--------|---------|----------|
| docker-steward | Docker, containers en lokale C4-visualisatie | 0 | 0 |
| layout-optimizer | Diagram-layout en visualisatie-optimalisatie | 0 | 0 |
| moeder | Workspace-ordening, governance, agent-lifecycle | 11 | 2 |
| python-expert | Python-ontwikkeling, code-kwaliteit | 6 | 1 |
